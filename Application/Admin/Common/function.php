    ...
    if($act_list != 'all'){
        ...
        foreach($menu_list as $k=>$mrr){
            foreach ($mrr['sub_menu'] as $j=>$v){
                if(!in_array(ucwords($v['control']).'Controller@'.$v['act'], $role_right)){
...
function getAllMenu(){
    return	array(
        'system' => array('name'=>'系统设置','icon'=>'fa-cog','sub_menu'=>array(
            ...
            //array('name'=>'电脑导航','act'=>'navigationList','control'=>'System'),
            array('name'=>'手机导航','act'=>'wapnavigationList','control'=>'System'),
        ...
        'member' => array('name'=>'会员管理','icon'=>'fa-user','sub_menu'=>array(
			...
			array('name'=>'会员关系','act'=>'user_pic','control'=>'User'),
        ...
        'Store' => array('name' => '店铺管理', 'icon'=>'fa-shopping-cart', 'sub_menu' => array(
            ...
            //array('name' => '线下店铺', 'act'=>'merchant_list', 'control'=>'Merchant'),
            ...
            array('name' => '类目审核', 'act'=>'apply_class_list', 'control'=>'Store'),
...
/*      'tools' => array('name' => '公众号设置', 'icon'=>'fa-plug', 'sub_menu' => array(
		...
		'detail' => array('name' => tpCache('distribut.jifeng_name').'明细', 'icon'=>'fa-plug', 'sub_menu' => array(
		    array('name'=>'债务债权','act'=>'zwzq_list','control'=>'Detail'),
            array('name'=>'奖金规则','act'=>'bonus_ruleList','control'=>'Detail'),            
			array('name'=>tpCache('distribut.equity_name').'分红','act'=>'equity_split','control'=>'Detail'),
            array('name'=>'平台帐户','act'=>'jifeng','control'=>'Detail'),
            array('name'=>'会员明细','act'=>'index','control'=>'Detail'),
