...
<html>
	...
	<body>
		...
		<div class="container">
			...
			<div class="other_content">
				...
				<div class="input_content">
					<button class="user-read-conform" id="user_read_conform">点击查看协议</button>
					<div class="user-read-area b_box" id="user_read_area">
				...
				<p>&nbsp;
					...
					<div class="user-agree-swooch b_box">
						<span>我同意以上协议</span>
						<input type="checkbox" field-name="user-agree" require="require" require-empty-tip="请先同意协议">
					</div>
				</div>
				<div class="input_next_step">
					<a href="javascript:;" next-type="next" next-page="/index.php?s=/Mobile/Newjoin/basic_info.html">下一步,填写联系方式</a>
				</div>
			</div>
		</div>
		...
		<script type="text/javascript">
			$(function() {
				$('#user_read_conform').on("click",function(){
					$(this).hide();
					var user_read_area = $("#user_read_area");
					user_read_area.show();
				});
