	...
	<div class="tac-sd">
    	<div class="wihe-ee">
            ...
            <br>
            	...
            	<div class="fail-fasu">
                	<img src="/Template/mobile/new/Static/images/suc_cg.png"/>
                	<p>支付完成</p>
                    <br>
                    <a href="<?php echo U('User/recharge',array('order_id'=>$order_id));?>">支付成功</a>
                </div>
                <div class="fail-I-success" >
                	<!--<img src="/Template/mobile/new/Static/images/qrcode_vmall_app01.png" width="110" height="110"/>-->
                    <?php echo ($code_str); ?>
                </div>
            	<div class="success-fasu">
                	<img src="/Template/mobile/new/Static/images/suc_sb.png"/>
                	<p>支付遇到问题</p>
                    <br>
