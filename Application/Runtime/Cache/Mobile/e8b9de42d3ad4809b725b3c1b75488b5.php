							...
							<div class="user_input_select" value="" select-next="no" field-name="sc_id" require="require" require-empty-tip="店铺主营大类未选择">
								...
								<div class="user_input_select_option_content">
									<ul class="user_input_select_option_content_ul">
										...
										<?php if(is_array($store_class)): foreach($store_class as $k=>$vo): ?><li value="<?php echo ($k); ?>"><p><?php echo ($vo["sc_name"]); ?></p></li><?php endforeach; endif; ?>
							 ...
							 field-name="bank_province">
								...
								<div class="user_input_select_option_content">
									<ul class="user_input_select_option_content_ul">
										...
										&lt;!&ndash; <?php if(is_array($province)): $i = 0; $__LIST__ = $province;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?></li><?php endforeach; endif; else: echo "" ;endif; ?> &ndash;&gt;
									</ul>
								</div>
							</div>
						</li>
