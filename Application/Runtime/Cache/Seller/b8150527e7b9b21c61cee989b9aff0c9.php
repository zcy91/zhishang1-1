               ...
               <nav class="navbar navbar-default">	     
				<div class="collapse navbar-collapse">
	                <div class="navbar-form pull-right margin">
	                    ...
	                    <a href="<?php echo U('Order/delivery_list');?>" data-toggle="tooltip" title="" class="btn btn-default" data-original-title="返回"><i class="fa fa-reply"></i></a>
	               </div>
	            </div>
	           </nav>
            ...
            <div class="panel-body">
                <table class="table table-bordered">
                    ...
                    <?php if(is_array($delivery_record)): $i = 0; $__LIST__ = $delivery_record;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$log): $mod = ($i % 2 );++$i;?><tr>
                            <td class="text-center"><?php echo ($log["seller_name"]); ?></td>
