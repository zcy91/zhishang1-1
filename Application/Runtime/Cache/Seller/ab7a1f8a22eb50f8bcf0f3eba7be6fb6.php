		              ...
		              <table id="list-table" class="table table-bordered table-striped dataTable">
						...
						<tbody>
						  <?php if(is_array($list)): foreach($list as $k=>$vo): ?><tr role="row" align="center">
		                     ...
		                     <td align="left"><?php echo ($vo["seller_name"]); ?></td>
		                     <td align="left"><?php echo ($vo["role"]); ?></td>
		                     <td><?php echo ($vo["add_time"]); ?></td>
		                     <td><img width="20" height="20" src="/Public/images/<?php if($vo[enabled] == 1): ?>yes.png<?php else: ?>cancel.png<?php endif; ?>" onclick="changeTableVal('seller','seller_id','<?php echo ($vo["seller_id"]); ?>','enabled',this)"/></td>
		                     <td>
