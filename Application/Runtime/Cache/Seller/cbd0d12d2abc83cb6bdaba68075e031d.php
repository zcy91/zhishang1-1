    ...
    <section class="content">
        ...
        <div class="container-fluid">
            <div class="pull-right">
                ...
                <a onclick="get_help(this)" id="get_help" data-url="http://www.net717.com" class="btn btn-default" href="javascript:;"><i class="fa fa-question-circle"></i> 帮助</a>                
            </div>
                    ...
                    <div class="tab-content">                 	  
                        <div class="tab-pane active" id="tab_tongyong">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <td>上传商品主图:</td>
                                    <td>
                                        <input type="button" value="上传主图"  onclick="GetUploadify(1,'','goods','call_back');"/>
                                ...
                                <tr>
                                    <td>商品单位:</td>
                                    <td>
                                        <input type="text" class="form-control" style="width:150px;" value="<?php echo ($goodsInfo["unit"]); ?>" name="unit"   />
                                ...
                                <tr>
                                    <td>赠送<?php echo tpCache('distribut.jifeng_name');?>:</td>
                                    <td>
                                        <input name="give_integral" type="text" class="form-control" style="width:150px;" onkeyup="this.value=this.value.replace(/[^\d.]/g,'')" value="<?php echo ($goodsInfo["give_integral"]); ?>" maxlength="3" onpaste="this.value=this.value.replace(/[^\d.]/g,'')" />%
                                        <span id="err_give_integral" style="color:#F00; ">购物赠送<?php echo tpCache('distribut.jifeng_name');?>比例，以本店价为准，请确保会员帐号有足够的<?php echo tpCache('distribut.hot_jifeng_name');?></span>					                                        
                                    </td>
                                </tr>
                                <tr>
                                    <td>可兑换<?php echo tpCache('distribut.jifeng_name');?>:</td>
                                    <td>
                                        <input name="exchange_integral" type="text" class="form-control" style="width:150px;" onkeyup="this.value=this.value.replace(/[^\d.]/g,'')" value="<?php echo ($goodsInfo["exchange_integral"]); ?>" maxlength="3" onpaste="this.value=this.value.replace(/[^\d.]/g,'')" />%
                                        <span id="err_exchange_integral" style="color:#F00;">允许使用<?php echo tpCache('distribut.jifeng_name');?>抵扣比例，全额抵扣为100</span>
                                    </td>
                                </tr>
                        ...
                        <div class="tab-pane" id="tab_goods_images">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <td>
                                        <div style="display:inline-block;width:100px; text-align:center; margin: 5px;" img-capital="img-capital"><a target="_blank" href="<?php echo ($goodsInfo["original_img"]); ?>"><img width="100" height="100" src="<?php echo ($goodsInfo["original_img"]); ?>"/></a><br><a href="javascript:void(0)" style="visibility: hidden">删除</a></div>
...
<script>
    ...
    function call_back(fileurl_tmp){
    	...
    	//添加完商品图片后默认为商品相册的第一张
        // var domStr='<div style="width:100px; text-align:center; margin: 5px; display:inline-block;" class="goods_xc" img-capital="img-capital"><input type="hidden" value="'+fileurl_tmp+'" name="goods_images[]"><a onclick="" href="'+fileurl_tmp+'" target="_blank"><img width="100" height="100" src="'+fileurl_tmp+'"></a><br><a href="javascript:void(0)" style="visibility: hidden" onclick="javascript:;">删除</a></div>';
        // var xiangce=$("#tab_goods_images .table-bordered td");
        // xiangce.find("div[img-capital=img-capital]").remove();
        // xiangce.prepend($(domStr));

        var xiangce=$("#tab_goods_images td div[img-capital=img-capital]");
        console.log(xiangce)
        xiangce.find("img").attr("src",fileurl_tmp);
        xiangce.find("a:first").attr("href",fileurl_tmp);
    }
    ...
    function call_back2(paths){
        ...
        var  last_div = $(".goods_xc:last");
        for (i=0;i<paths.length ;i++ )
        {
            var html = '<div class="goods_xc" style="width:100px; text-align:center; margin: 5px; display:inline-block;"><input type="hidden" name="goods_images[]" value="'+paths[i]+'"><a href="'+paths[i]+'" target="_blank"><img src="'+paths[i]+'" width="100" height="100"></a><br><a href="javascript:;")">删除</a></div>';
            var dom = $(html);
            dom.find("a:last").attr("onclick","ClearPicArr2(this,'"+paths[i]+"')");
            //onclick="ClearPicArr2(this,"'+paths[i]+'"
            last_div.before(dom);
...
$(document).ready(function(){
	...
	// 如果是编辑的时候 加载 规格 和属性
	<?php if($goodsInfo['cat_id3'] > 0): ?>ajaxGetSpecAttr(<?php echo ($goodsInfo['goods_id']); ?>,<?php echo ($goodsInfo['cat_id3']); ?>);<?php endif; ?>			
