    ...
    <div class="table-responsive">
        <table class="table table-bordered table-hover">
            ...
            <tr>
                ...
                <td class="text-left">
                    <a href="javascript:sort('shop_price');">赠送比例</a>
                </td>
                <td class="text-left">
                    <a href="javascript:sort('shop_price');">抵扣比例</a>
                </td>
            ...
            <?php if(is_array($goodsList)): $i = 0; $__LIST__ = $goodsList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td class="text-left"><?php echo ($list["give_integral"]); ?>%</td>
                    <td class="text-left"><?php echo ($list["exchange_integral"]); ?>%</td>
                    ...
                    <td class="text-right">
                        <a  target="_blank" href="<?php echo U('Mobile/Goods/goodsInfo',array('id'=>$list['goods_id']));?>" data-toggle="tooltip" title="" class="btn btn-info" data-original-title="查看详情"><i class="fa fa-eye"></i></a>
