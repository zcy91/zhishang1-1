		              ...
		              <table id="list-table" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
		                 <thead>
		                   <tr role="row">
			                   ...
			                   <th class="sorting" tabindex="0" style="display:none">消费额度</th>
			                   <th class="sorting" tabindex="0" style="display:none">折扣率</th>
			                   <th class="sorting" tabindex="0">等级描述</th>
			                   <th class="sorting" tabindex="0">操作</th>
		                   </tr>
		                 </thead>
						<tbody>
						  <?php if(is_array($list)): foreach($list as $k=>$vo): ?><tr role="row" align="left">
		                     <td><?php echo ($vo["level_id"]); ?></td>
		                     <td><?php echo ($vo["level_name"]); ?></td>
		                     <td style="display:none"><?php echo ($vo["amount"]); ?></td>
		                     <td  style="display:none"><?php echo ($vo["discount"]); ?>%</td>
		                     ...
		                     <td>
		                      ...
		                      <a class="btn btn-danger" href="javascript:void(0)" data-url="<?php echo U('User/levelHandle');?>" data-id="<?php echo ($vo["level_id"]); ?>" onclick="delfun(this)" style="display:none"><i class="fa fa-trash-o"></i></a>
							</td>
