       ...
       <div class="row">
			...
			<?php if(is_array($cat_list)): foreach($cat_list as $k=>$vo): ?><tr role="row" align="center" class="<?php echo ($vo["level"]); ?>" id="<?php echo ($vo["level"]); ?>_<?php echo ($vo["id"]); ?>" <?php if($vo[level] > 1): ?>style="display:none"<?php endif; ?>>
	                     ...
	                     <td align="left" style="padding-left:<?php echo ($vo[level] * 5); ?>em"> 
                          ...
                          <td>/index.php?s=/Mobile/Goods/goodsList/id/<?php echo ($vo["id"]); ?></td>
                         <td><span><?php echo ($goods_type[$vo[type_id]]); ?></span></td>
                         <td>
	                     ...
	                     <td  style="display:none">                                 
                         	<input type="text" onchange="updateSort('goods_category','id','<?php echo ($vo["id"]); ?>','commission',this)"  onkeyup="this.value=this.value.replace(/[^\d]/g,'')" onpaste="this.value=this.value.replace(/[^\d]/g,'')"  size="4"value="<?php echo ($vo["commission"]); ?>" class="input-sm" />
                         </td>                         
	                     <td>                                 
