                            ...
                            <form action="" id="search-form2" class="navbar-form form-inline" method="post" onsubmit="return false">
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="hidden" name="sq" value="<?php echo I('sq');?>">
                                ...
                                <button type="button" onclick="send_message(0);" class="btn btn-primary" style=" display:none"><i class="fa"></i> 发送站内信</button>
                                <button type="button" onclick="send_mail();" class="btn btn-primary" style=" display:none"><i class="fa"></i> 发送邮箱</button>
								 <a href="<?php echo U('User/add_user');?>" class="btn btn-info pull-right">添加会员</a>
                                 <a href="<?php echo U('User/index',Array('sq'=>1));?>" class="btn btn-info pull-right" style="margin-right:15px">申请债务债权</a>
                                 <a href="<?php echo U('User/index');?>" class="btn btn-info pull-right" style="margin-right:15px">所有会员</a>
                            </form>
                    </div>
                    <div id="ajax_return">
