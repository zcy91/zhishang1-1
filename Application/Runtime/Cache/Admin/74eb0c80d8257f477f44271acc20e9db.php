        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="" method="post" onsubmit="return checkUserUpdate(this);">
                    ...
                    <tbody>
                    <tr>
                        <td class="col-sm-2">推荐人ID:</td>
                        <td ><input type="text" name="first_leader" class="form-control" value="<?php echo I('get.id',0);?>" onkeyup="value=value.replace(/[^\d{1,}\.\d{1,}|\d{1,}]/g,'')"></td>
                        <td>没有推荐人请填0</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td ><input type="text" class="form-control" name="sfx" value=""></td>
                        <td></td>
                    </tr>
