...
<div class="wrapper">
	...
	<section class="content">
       <div class="row">
		              ...
		              <table id="list-table" class="table table-bordered table-striped dataTable">
						...
						<tbody>
                          <?php if(is_array($list)): foreach($list as $k=>$vo): ?><tr role="row">    
		                     ...
		                     <td><img width="20" height="20" src="/Public/images/<?php if($vo[store_state] == 1): ?>yes.png<?php else: ?>cancel.png<?php endif; ?>" onclick="changeTableVal('store','store_id','<?php echo ($vo["store_id"]); ?>','store_state',this)"/></td>
		                     ...
		                     <td><img width="20" height="20" src="/Public/images/<?php if($vo[is_own_shop] == 1): ?>yes.png<?php else: ?>cancel.png<?php endif; ?>" onclick="changeTableVal('store','store_id','<?php echo ($vo["store_id"]); ?>','is_own_shop',this)"/></td>
		                     <td><img width="20" height="20" src="/Public/images/<?php if($vo[bind_all_gc] == 1): ?>yes.png<?php else: ?>cancel.png<?php endif; ?>" onclick="changeTableVal('store','store_id','<?php echo ($vo["store_id"]); ?>','bind_all_gc',this)"/></td>
		                     <td class="text-center">
                                <a class="btn btn-info" href="<?php echo U('Seller/index/index',array('store_id'=>$vo['store_id']));?>"  target="_blank" title="管理店铺"><i class="fa fa-user"></i></a>
		                      	<a class="btn btn-info" href="<?php echo U('Store/store_info',array('store_id'=>$vo['store_id']));?>" title="查看信息"><i class="fa fa-eye"></i></a>
		                      	<a class="btn btn-info" href="<?php echo U('Store/store_info_edit',array('store_id'=>$vo['store_id']));?>" title="修改信息"><i class="fa fa-pencil"></i></a>
		                      	<a class="btn btn-info" href="<?php echo U('Store/store_class_info',array('store_id'=>$vo['store_id']));?>" title="经营类目"><i class="fa fa-tasks"></i></a>
		                      	<a class="btn btn-danger" onclick="delfunc(this)" data-url="<?php echo U('Store/store_del');?>" data-id="<?php echo ($vo["store_id"]); ?>" title="删除店铺"><i class="fa fa-trash-o"></i></a>
				     		 </td>
              ...
              <div class="row">
              	    <div class="col-sm-6 text-left"><button class="btn btn-default btn-sm checkbox-toggle"><i class="fa fa-square-o"></i></button></div>
