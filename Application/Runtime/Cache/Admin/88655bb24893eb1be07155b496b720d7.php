    ...
    <div class="container-fluid">
      <div class="panel panel-default">
		...
		<div class="navbar navbar-default">                    
                <form id="search-form2" class="navbar-form form-inline"  method="post" action="<?php echo U('withdrawals');?>">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <th class="sorting text-left">帐号</th>
                                <th class="sorting text-left">昵称</th>                                                          
                                <th class="sorting text-left">申请金额</th>
                                <th class="sorting text-left">实际到帐</th>
                            ...
                            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <td class="text-left">
                                            <?php echo (about_xin("users","user_id=".$v["user_id"],'mobile','mobile')); ?>
                                    </td>
                                    <td class="text-left">
                                    ...
                                    <td class="text-left"><?php echo ($v["fee"]); ?></td>
                                    ...
                                    <td class="text-left">
                                        <a href="<?php echo U('editWithdrawals',array('id'=>$v['id'],'p'=>$_GET[p]));?>" data-toggle="tooltip" title="" class="btn btn-primary" data-original-title="编辑"><i class="fa fa-pencil"></i></a>                                        
		...
		$.ajax({
			...
			success: function(v){	
                            ...
                            if(v.hasOwnProperty('status') && (v.status == 1))
                               location.href='<?php echo U('Admin/Finance/withdrawals');?>';
                            else                                
