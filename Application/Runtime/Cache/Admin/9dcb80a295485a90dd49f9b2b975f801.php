				      ...
				      <div class="collapse navbar-collapse">
	    				<div class="navbar-form form-inline">
				            <div class="form-group">
				             ...
				             <div class="form-group">
                                 <a class="btn btn-default" href="<?php echo U('/Home/Index/index',array('edit_ad'=>1));?>" style="display:none">首页</a>&nbsp;&nbsp;&nbsp;&nbsp;                                            
                                 ...
                                 <select class="form-control" name="intro" onchange="if(this.value != 0) location.href='/index.php?m=Home&c=Channel&a=index&edit_ad=1&id='+this.value;" style="display:none">
