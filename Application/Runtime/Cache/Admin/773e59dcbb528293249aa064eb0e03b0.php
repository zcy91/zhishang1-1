                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            ...
                            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <td class="text-left"><?php echo ($v["store_id"]); ?></td>
                                    <td class="text-left"><a href="<?php echo U('Store/store_info',array('store_id'=>$v[store_id]));?>"><?php echo ($v["store_name"]); ?></a></td>                               
                                    ...
                                    <td class="text-left"><a href="<?php echo U('order_statis_detail',array('store_id'=>$v['store_id'],'date_s'=>$v[start_date],'date_e'=>$v[end_date]));?>">查看</a></td>
