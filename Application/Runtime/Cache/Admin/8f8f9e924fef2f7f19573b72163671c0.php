	             ...
	             <div class="box-body">	             
	            	...
	            	<div class="col-sm-12">
		              <table id="list-table" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
		                 <thead>
		                   <tr role="row">
			                   <th class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending">文章标题</th>
                               ...
                               <th class="sorting" tabindex="0" aria-controls="example1"  >链接</th>
						...
						<tbody>
						  <?php if(is_array($list)): foreach($list as $k=>$vo): ?><tr role="row" align="center">
		                     <td align="left" valign="middle"><?php echo (getSubstr($vo["title"],0,33)); ?></td>
		                     <td align="left" valign="middle"><?php echo ($vo["category"]); ?></td>
		                     <td align="left" valign="middle"><?php echo ($vo["kewords"]); ?></td>
		                     ...
		                     <td align="left" valign="middle"><?php echo ($vo["add_time"]); ?></td>
                             <td align="left" valign="middle"><?php echo 'http://'.$_SERVER['HTTP_HOST']; echo U('Mobile/Article/index',array('article_id'=>$vo['article_id']));?></td>
		                     <td>
		                     <a target="_blank" href="<?php echo U('Mobile/Article/index',array('article_id'=>$vo['article_id']));?>" data-toggle="tooltip" title="" class="btn btn-info" data-original-title="查看详情" style="display:none"><i class="fa fa-eye"></i></a>
