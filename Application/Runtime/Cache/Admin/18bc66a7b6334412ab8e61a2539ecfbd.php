                    ...
                    <div class="navbar navbar-default">
                            <form action="<?php echo U('Admin/order/export_order');?>" id="search-form2" class="navbar-form form-inline" method="post">
                                <div class="form-group">
                                    <label class="control-label" for="input-order-id">店铺</label>
                                    <div class="input-group">
                                        <input type="text" name="store_name" placeholder="店铺名称" id="input-store-id" class="input-sm" style="width:100px;">
                                    </div>
                                </div>                               
                                <div class="form-group">
