                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td>联系人邮箱:</td><td><?php echo ($apply["contacts_email"]); ?></td>
				                    ...
				                    <tr>
				                        <td>经纬度定位:</td><td><?php echo ($store["lng_lat"]); ?></td>
				                        <td>快捷支付赠送<?php echo tpCache('distribut.jifeng_name');?>:</td><td><?php echo ($store["gift_jifeng"]); ?>%</td>
				                        <td>快捷支付抵扣<?php echo tpCache('distribut.jifeng_name');?>:</td><td><?php echo ($store["arrive_jifeng"]); ?>%</td>
				                    </tr>
                    </tbody>
                </table>
            </div>
