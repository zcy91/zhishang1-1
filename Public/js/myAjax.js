...
function changeTableVal(table,id_name,id_value,field,obj)
{
		...
		if((table=="users") && (id_name="user_id") && (field="is_sq")  && (value==1)){
		$.ajax({
				url:"/index.php?m=Admin&c=Index&a=changeTableVal&table="+table+"&id_name="+id_name+"&id_value="+id_value+"&field=level&value=2",success: function(data){}
		});	
		}
