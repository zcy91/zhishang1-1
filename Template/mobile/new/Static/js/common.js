...
{                                            
	let str="goods_num="+$("#buy_amount_show").text();
    ...
    if($("#buy_goods_form").length > 0){      
        ...
        $.ajax({
            ...
            success: function(data){
			   ...
			   if(to_catr == 1)  //直接购买
			   {
				   //location.href = "/index.php?m=Mobile&c=Cart&a=cart2&cart="+$("input[ name='goods_id' ] ").val();
				   location.href = "/index.php?m=Mobile&c=Cart&a=cart2&cart="+$("#goods_id").val();
			   }else{
